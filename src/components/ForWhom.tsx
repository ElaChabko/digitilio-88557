  ...
  return <section id="for-whom" className="py-32 bg-gradient-to-b from-background via-accent/5 to-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl">
          <motion.h2 className="text-5xl md:text-7xl lg:text-8xl font-bold text-foreground mb-16 leading-tight tracking-tight" initial={{
          opacity: 0,
          y: 30
        }} whileInView={{
          opacity: 1,
          ...
          <motion.p className="text-2xl md:text-3xl text-muted-foreground leading-relaxed font-light" initial={{
          opacity: 0,
          y: 20
        }} whileInView={{
          opacity: 1,
