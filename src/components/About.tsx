...
export const About = () => {
  ...
  return (
    <section id="about" className="py-32 bg-gradient-to-b from-background via-accent/5 to-background relative overflow-hidden">
      {/* Decorative elements */}
      <motion.div 
        className="absolute bottom-20 right-20 w-[350px] h-[350px] bg-accent/10 rounded-full blur-3xl"
        animate={{ 
          scale: [1, 1.15, 1],
      ...
      <div className="container mx-auto px-4 relative z-10" ref={ref}>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-5 gap-16 items-start">
          ...
          >
            <motion.div
              className="relative rounded-3xl overflow-hidden shadow-[0_20px_60px_hsl(263_33%_35%/0.15)] group-hover:shadow-[0_30px_80px_hsl(263_33%_35%/0.25)] transition-shadow duration-500"
