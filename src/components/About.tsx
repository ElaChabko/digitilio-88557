      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10" ref={ref}>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-5 gap-8 sm:gap-10 md:gap-12 lg:gap-16 items-start">
          ...
          ease: [0.22, 1, 0.36, 1]
            ...
            duration: 0.5,
            delay: 0.4
          }} className="text-sm leading-relaxed sm:text-base md:text-lg lg:text-xl text-muted-foreground font-light">
            ...
            duration: 0.5,
            delay: 0.6
          }} className="text-base leading-relaxed sm:text-lg md:text-xl lg:text-2xl text-foreground font-normal">
